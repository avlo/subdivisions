...
public class NostrRelayServiceRedis {
  ...
  public NostrRelayServiceRedis(@Value("${superconductor.relay.url}") @NonNull String relayUri, @NonNull SslBundles sslBundles) {
    log.debug("relayUri: \n{}", relayUri);
  ...
  public List<EventMessage> send(@NonNull ReqMessage reqMessage) throws JsonProcessingException, NostrException {
    TestSubscriberRedis<EventMessage> subscriber = new TestSubscriberRedis<>();
